...
This weirdo routing manipulations are necessary to properly collect all information from CRM template script. Note, that this action will use 2 license calls.
